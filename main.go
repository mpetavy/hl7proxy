...
func main() {
	...
	common.New(&common.App{"hl7proxy", "1.0.2", "2018", "Persistent connection proxy", "mpetavy", common.APACHE, "https://github.com/mpetavy/hl7proxy", true, nil,start, stop, nil, 0}, []string{"s", "d"})
	common.Run()
}
